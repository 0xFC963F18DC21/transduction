...
import net.nergi.transduction.{Reduced, Reducer, Reduction, Transducer => ImmutableTransducer}
...
/** Explicitly mutable-state (or stateless) transducers. These are more flexible in their typing,
  ...
  */
trait Transducer[I1, I2] extends ImmutableTransducer[Unit, Unit, I1, I2] {}
